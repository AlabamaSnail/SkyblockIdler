...
var skill_speed = (100 * pow(0.8, StatHolder.farming)) * pow(2.0, (StatHolder.farmingRebirthUpgrade * 1.0))
...
func _ready() -> void:
	...
	skill_speed = (100 * pow(0.8, StatHolder.farming)) * pow(2.0, (StatHolder.farmingRebirthUpgrade * 1.0))
func _process(delta):
